...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/oneWrite7secs.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../src/system_config/pic32mz_ef_curiosity/bsp/bsp.c ../src/system_config/pic32mz_ef_curiosity/framework/driver/tmr/src/dynamic/drv_tmr.c ../src/system_config/pic32mz_ef_curiosity/framework/driver/usb/usbhs/src/dynamic/drv_usbhs.c ../src/system_config/pic32mz_ef_curiosity/framework/driver/usb/usbhs/src/dynamic/drv_usbhs_host.c ../src/system_config/pic32mz_ef_curiosity/framework/peripheral/adchs/drv_adc_static.c ../src/system_config/pic32mz_ef_curiosity/framework/system/clk/src/sys_clk_static.c ../src/system_config/pic32mz_ef_curiosity/framework/system/devcon/src/sys_devcon.c ../src/system_config/pic32mz_ef_curiosity/framework/system/devcon/src/sys_devcon_pic32mz.c ../src/system_config/pic32mz_ef_curiosity/framework/system/devcon/src/sys_devcon_cache_pic32mz.S ../src/system_config/pic32mz_ef_curiosity/framework/system/fs/src/dynamic/sys_fs.c ../src/system_config/pic32mz_ef_curiosity/framework/system/fs/src/dynamic/sys_fs_media_manager.c ../src/system_config/pic32mz_ef_curiosity/framework/system/fs/ff.c ../src/system_config/pic32mz_ef_curiosity/framework/system/fs/diskio.c ../src/system_config/pic32mz_ef_curiosity/framework/system/int/src/sys_int_pic32.c ../src/system_config/pic32mz_ef_curiosity/framework/system/ports/src/sys_ports_static.c ../src/system_config/pic32mz_ef_curiosity/framework/system/tmr/src/sys_tmr.c ../src/system_config/pic32mz_ef_curiosity/framework/usb/src/dynamic/usb_host.c ../src/system_config/pic32mz_ef_curiosity/framework/usb/src/dynamic/usb_host_msd.c ../src/system_config/pic32mz_ef_curiosity/framework/usb/src/dynamic/usb_host_scsi.c ../src/system_config/pic32mz_ef_curiosity/system_init.c ../src/system_config/pic32mz_ef_curiosity/system_interrupt.c ../src/system_config/pic32mz_ef_curiosity/system_exceptions.c ../src/system_config/pic32mz_ef_curiosity/system_tasks.c ../src/app.c ../src/main.c ../src/timer.c ../src/switch.c ../src/adc.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-pic32mz_ef_curiosity.mk dist/${CND_CONF}/${IMAGE_TYPE}/oneWrite7secs.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/oneWrite7secs.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/oneWrite7secs.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_pic32mz_ef_curiosity=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x37F   -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_heap_size=501,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/oneWrite7secs.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/oneWrite7secs.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_pic32mz_ef_curiosity=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=501,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/oneWrite7secs.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
